...
@property (nonatomic, copy, readwrite) NSDictionary *site; // 作者信息 存放字典数组
//@property (nonatomic, copy, readwrite) NSString *icon; // 作者头像
//@property (nonatomic, copy, readwrite) NSString *name; // 作者名
//@property (nonatomic, copy, readwrite) NSString *url; // 作者主页
//@property (nonatomic, copy, readwrite) NSString *description; // 作者个签
//@property (nonatomic, copy, readwrite) NSString *followers; // 粉丝数量
