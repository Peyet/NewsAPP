...
@interface ZPJNotification ()<UNUserNotificationCenterDelegate>

@property (nonatomic, strong) ZPJNotification *notificationManager;

@end

@implementation ZPJNotification

+ (ZPJNotification *)sharedNotification {
    static ZPJNotification *notificationManager;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        notificationManager = [[ZPJNotification alloc] init];
    });
