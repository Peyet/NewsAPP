...
@property (nonatomic, strong) UILabel *authorAvatarLabel;

@property (nonatomic, strong) UIButton *closeButton;

@end

@implementation ZPJVideoToolbar
...
- (void)_deleteButtonClick {
    ZPJDeleteView *deleteView = [ZPJDeleteView new];
...
- (void)_closeClicked {
    ZPJDeleteView *deleteView = [[ZPJDeleteView alloc] initWithFrame:[UIApplication sharedApplication].keyWindow.frame];
    [deleteView showDeleteViewFromPoint:CGPointMake(0, 0) clickBlock:^{
